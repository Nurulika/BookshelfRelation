// src/lib.rs
/*
 * Core library for BookshelfRelation
 */
...
#[derive(Debug)]
pub struct BookshelfRelationProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BookshelfRelationProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BookshelfRelation processing");
    
    let mut processor = BookshelfRelationProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BookshelfRelationProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BookshelfRelationProcessor::new(false);
